...
public abstract class StackTest {
    ...
    public final void testEmptyPushEmpty() {
        /*
         * Set up variables and call method under test
         */
        Stack<String> s = this.constructorTest();
    ...
    @Test
    public final void testEmptyPushNonEmpty() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testDoublePushNonEmpty() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "blue");
        Stack<String> sExpected = this.createFromArgsRef("purple", "green", "red",
                "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testDoublePopNonEmpty() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("green", "red", "blue");
